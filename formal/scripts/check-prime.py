...
Run:  python3 formal/scripts/check-prime.py
"""

import random
import sys

# BN254 scalar field modulus (circom's default prime r) -- Lelantos/Field.lean :: p
...
# Baby Jubjub prime-order subgroup order -- Lelantos/Jubjub.lean :: ell
