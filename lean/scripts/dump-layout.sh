...
# 2x2 shape only. For 3x3 this script pins Lean against its own expectation, which catches
# an accidental layout change but does not cross-check anything else.
#
...
# shape name -> N_IN N_OUT, matching src/2x2.circom and src/3x3.circom.
SHAPES=("2x2 2 2" "3x3 3 3")
