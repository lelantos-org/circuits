// Modular square roots and Legendre symbols in BN254 Fr, used by the FMD clue
// bit derivation.
//
// BN254 has 2-adicity 28, so the `p ≡ 3 (mod 4)` shortcut does not apply and
...
/**
 * Witness pair for the HashToBit gadget.
 * bit=1 ⇒ hash is a QR and y² = hash; bit=0 ⇒ hash is a QNR and y²·Z = hash.
 * Throws on hash=0 (probability 1/r — indicates a bug, not bad luck).
 */
